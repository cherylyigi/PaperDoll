...
public class Canvas extends JPanel {
	...
	private void KeyBinding() {
        getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(KeyEvent.VK_Q, InputEvent.CTRL_MASK), "ctrl + q");
		
        getActionMap().put("ctrl + q", new AbstractAction() 
        {
		...
		getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(KeyEvent.VK_R, InputEvent.CTRL_MASK), "ctrl + r");
